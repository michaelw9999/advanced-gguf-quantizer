...
template<typename src0_t, typename dst_t, typename index_t = int32_t>
static __global__ void k_get_rows_float(
        const src0_t * src0_ptr, const index_t * src1_ptr, dst_t * dst_ptr,
        const int64_t ne00, /*const int64_t ne01, const int64_t ne02, const int64_t ne03,*/
        /*const int64_t ne10,*/ const int64_t ne11, const uint3 ne12_fdv, /*const int64_t ne13,*/
        /*const size_t s0,*/ const size_t s1, const size_t s2, const size_t s3,
        /*const size_t nb00,*/ const size_t nb01, const size_t nb02, const size_t nb03,
...
static __global__ void k_get_rows_float_vec(
    ...
    for (int64_t z = blockIdx.z; z < ne11*(int64_t)ne12_fdv.z; z += gridDim.z) {
        ...
        int4 * GGML_CUDA_RESTRICT dst_row =
            (int4 *) (dst_ptr + i10*s1 + i11*s2 + i12*s3);
        const int4 * GGML_CUDA_RESTRICT src0_row =
            (const int4 *) ((const char *) src0_ptr + i01*nb01 + i11*nb02 + i12*nb03);
...
static void ggml_cuda_get_rows_switch_src0_type(
    ...
    switch (src0_type) {
        ...
        case GGML_TYPE_MXFP8:
            if (blackwell_mma_available(ggml_cuda_info().devices[ggml_cuda_get_device()].cc)) {
                get_rows_cuda_mxfp8_tiled(src0_d, src1_d, dst_d,
                    ne00, ne01, ne02, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            } else {
                get_rows_cuda_q<QK_MXFP8, 1, dequantize_mxfp8>(src0_d, src1_d, dst_d,
                    ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            }
            break;
